...
function addsyllabus({allcategory, teacherid, allsubcategories, mycourseOptions}) {
                    ...
                    <form className="mbr-form"  data-form-title="My Mobirise Form" onSubmit={addSyllabus} method="POST">
                        ...
                        <div className="row input-main">
                            <div className="col-md-12 col-lg-12 input-wrap" data-for="firstname">
                                <input type="text" className="field display-7" name="syllabusName" placeholder="Enter Class Title"  value={syllabusName} onChange={(e)=>{setsyllabusName(e.target.value)}} required="" id="firstname-form2-7"/>
                            </div>
