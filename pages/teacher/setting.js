    ...
    <div className="row justify-content-center pt-2"> 
        ...
        <div className="row"> 
                        ...
                        <div className="left_navigation">
                                <div className="">
                                <ul>
                                    <a href="/teacher/setting?tabs=1"><li>Personal information</li></a>
                                    <a href="/teacher/setting?tabs=2"><li>Change Avatar</li></a>
                                    <a href="/teacher/setting?tabs=3"><li>Change Password</li></a>
                                    <a href="/teacher/notification"><li>Notification</li></a>
